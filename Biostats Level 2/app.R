...
ui <-fluidPage(
  ...
  # Website title
  titlePanel("Inferential Statistics for Introductory Biology Laboratory, Level 2"),
    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel('Group tests',
                 ...
                 p("Use this test if your continuous variable is NOT normally distributed within two groups"),
        ...
        # ANOVA and KW tests with post-hoc comparisons 
